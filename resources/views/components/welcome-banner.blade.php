<section class="w-full h-[809px] flex py-12 px-[184px] bg-[url('/assets/frontend/images/welcome.png')] bg-no-repeat mx-auto relative">
    ...
    <img src="{{asset('assets/frontend/images/chain11.svg')}}" class="absolute top-[72.5px] left-1">
    <img src="{{asset('assets/frontend/images/chain2.svg')}}" class="absolute bottom-0 left-[648px]">
    <img src="{{asset('assets/frontend/images/chain3.svg')}}" class="absolute top-[72.5px] right-0">
    <img src="{{asset('assets/frontend/images/chain4.svg')}}" class="absolute top-[72.5px] left-96">
</section>
