                        ...
                        <form wire:submit.prevent="save">
                                ...
                                <div class="flex-col space-y-4 bg-white rounded px-4 py-5 sm:p-6">
                                    ...
                                    <div class="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <input name="meta_description" wire:model="meta_description" class="form-input block w-full border-gray-300 rounded-md shadow-sm focus:ring-sky-500 focus:border-sky-500 sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed" type="text" maxlength="255">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow sm:rounded-md">
                                <div class="flex-col space-y-4 bg-white rounded px-4 py-5 sm:p-6">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            @livewire('components.input.multi-select', ['options' => $all_categories, 'selected' => $categories])
                                            <!-- <label for="description" class="flex items-center text-sm font-medium text-gray-700 py-1">
                                                <span class="block">
                                                    Category<br>
                                                </span>
                                        ...
                                        <div>
                                            <x-input.tags id="tags" wire:model="tags" />
                                            <!-- <label for="description" class="flex items-center text-sm font-medium text-gray-700 py-1">
                                                <span class="block">
                                                    Tag<br>
                                                </span>
