<section>
    <div class="flex flex-col px-6 mx-auto max-w-screen-2xl sm:px-10 justify-between pb-28">
        <div class="py-20">
            <div class="flex">
                <a class="border cursor-pointer border-sg-base-blue rounded-full p-1" href="{{ route('home') }}">
        ...
        <div class="max-w-[530px] flex gap-8 mx-auto flex-col items-center">
            <div class="flex flex-col gap-4">
                <h1 class="text-5xl font-semibold text-center text-sg-base">Create new password</h1>
            ...
            <div class="flex flex-col gap-6 items-center w-full">
                ...
                <button wire:click="resetPassword" class="rounded-xl bg-sg-base-blue text-base leading-7 py-4 text-center w-full text-white font-semibold">Reset Password</button>
            </div>
