<section class="w-full flex mx-auto flex-row py-[120px] px-[184px] bg-[url('/assets/frontend/images/19336.png')]">
    <div class="rounded-l-[32px] bg-[#EBF0F8] flex-1 px-12 py-10 relative flex items-center">
        <div class="flex flex-col gap-8">
            <p class="font-bold text-sg-base text-5xl leading-[62.4px]">Subscribe to our newsletter</p>
            <form action="" method="post" class="flex flex-col gap-2 text-base font-normal leading-[26px] text-black">
                <div class="flex flex-row gap-2.5">
                    <input type="text" name="firstname" placeholder="First name" class="flex-1 rounded-[9px] bg-white border border-white placeholder-[#707070] text-base py-[17px] pl-5 focus:border-sg-base-blue focus:ring-white">
                    <input type="text" name="email" placeholder="Email address" class="flex-1 rounded-[9px] bg-white border border-white placeholder-[#707070] text-base py-[17px] pl-5 focus:border-sg-base-blue focus:ring-white">
                </div>
                <button type="submit" class="font-semibold bg-sg-base-blue text-white rounded-2xl py-4">Subscribe Now</button>
            </form>
        </div>
    ...
    <div class="rounded-r-[32px] bg-sg-base-blue flex-1 px-12 py-10 justify-between flex flex-col relative">
        ...
        <button class="rounded-2xl bg-white text-sg-base-blue w-64 text-base leading-7 font-semibold py-4">Let’s find out</button>
