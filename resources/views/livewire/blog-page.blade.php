                            ...
                            <header class="block">
                                <div class="mb-8 max-h-[350px] relative">
                                    <a href="https://sugarmds.com/the-insulin-resistance-diet-reverse-insulin-resistance-now/">
                                        <img width="724" height="483" src="{{ $latest_blog->image }}" class="max-h-[350px] w-full object-cover opacity-100 transition-opacity inline-block max-w-full align-middle rounded-3xl" alt="Legumes" decoding="async" fetchpriority="high" sizes="(max-width: 724px) 100vw, 724px">
                                    </a>
