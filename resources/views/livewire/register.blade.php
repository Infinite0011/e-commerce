    ...
    <div class="flex flex-row px-6 mx-auto max-w-screen-2xl sm:px-10 justify-between py-28">
        <div class="w-1/3 flex flex-col justify-between gap-6">
            <div class="flex flex-col gap-6">
                <h1 class="text-4xl font-semibold text-[#212121]">Create an account</h1>
            ...
            <div class="flex flex-col gap-6">
                ...
                <label class="flex items-center text-sm rounded-sm cursor-pointer">
                    ...
                    <span class="ml-2">I agree to SugarMD <a class="text-[#2A62FE] cursor-pointer">Terms of Service</a> and <a class="text-[#2A62FE] cursor-pointer">Privacy Policy</a></span>
                </label>
                <button wire:click.prevent="registerStore" class="text-base font-semibold text-white bg-[#2A62FE] w-full p-4 rounded-xl cursor-pointer text-center">Sign up</button>
            ...
            <div class="text-center">
                Already have an account? <a href="{{ route('login.view') }}" class="text-[#2A62FE] cursor-pointer">Login</a>
            </div>
        </div>
