        ...
        <div class="flex-col px-4 py-5 space-y-4 bg-white sm:p-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    <x-hub::input.group
                            label="Discount"
                            :errors="$errors->get('variant.discount')"
                            for="discount"
                    >
                        <x-hub::input.text type="number" wire:model="variant.discount" id="discount" wire:change="updateDiscount" :disabled="$isBaseVariant"/>
                    </x-hub::input.group>
                </div>
            </div>
            <div class="space-y-4">
