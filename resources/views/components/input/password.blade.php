...
<input
  ...
  :type="type"
>
  <button type="button" class="flex items-center right-2 absolute ml-2 text-red-400" x-on:click="type = 'password'" x-show="type == 'text'">
    <x-hub::icon  ref="eye-off" style="solid" class="w-6" />
  </button>
  <button type="button" class="flex items-center right-2 absolute ml-2 text-gray-300 hover:text-gray-400" x-on:click="type = 'text'" x-show="type == 'password'">
